...
- Full regression: 3,242 passing tests after writer hardening; focused runtime/agent checks also cover progress-to-final composition and future source changes after corrections. CI checks are attached to the staging PRs.
