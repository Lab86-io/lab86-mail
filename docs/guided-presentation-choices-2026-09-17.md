...
- Preserve plan/recovery outputs up to 128,000 UTF-8 bytes across saved chat history, including Unicode-heavy source material. Oversized omitted plans explicitly require reconstruction from retained input evidence and never claim success or readiness.
