...
- When asked to create or change smart labels/rules → use create_smart_label, update_smart_label, create_smart_rule, or apply_smart_correction. These are local UI classification changes only. Do not call apply_smart_labels unless the user explicitly confirms writing Gmail labels.
