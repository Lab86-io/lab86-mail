...
- "The week ahead": today → +7 days of calendar as a clean timeline/table; for notable meetings propose prep (attendees & context, related tasks/docs, a short suggested agenda) and offer a one-tap prep task. When an event has a calendarId you may offer Yes/Maybe/No controls via rsvp_event, and you may propose a create_event focus/prep hold (reuse the account of a real event from data.calendar; pass startAt/endAt as epoch ms).
