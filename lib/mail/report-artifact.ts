...
.caption{max-width:1120px;margin:.55rem auto 0;padding:0 1.25rem;color:var(--brief-accent-2,var(--brief-muted));font-size:.68rem;letter-spacing:.08em;text-transform:uppercase}
...
.narrative h3{margin:.45rem 0 0;font-size:.72rem;font-weight:750;letter-spacing:.12em;text-transform:uppercase;color:var(--brief-accent-2,var(--brief-accent))}
...
.section-title{display:flex;align-items:center;gap:.85rem;margin:0 0 1rem;font-family:var(--brief-font-display);font-size:.82rem;font-weight:700;letter-spacing:max(var(--brief-display-tracking),.12em);text-transform:uppercase;color:var(--brief-accent-2,var(--brief-ink))}
...
.tag{font-size:.68rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--brief-accent-2,var(--brief-accent))}
