...
- entity_list: optional title, variant rows|cards|compact, items with
  {ref:{kind,id,account?,label?}, framing:{reason?,lane?,prep?}, actions:[]}.
...
EDITORIAL RULES
- Analyze the bodies and connect mail, calendar, tasks, tools, and Areas; do not transcribe sections.
