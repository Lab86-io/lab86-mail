...
2. When the user names an area, create it with area_create. Then INVESTIGATE before asking anything: use area_domain_activity for any domain or sender you suspect belongs to it, and corpus_search / sender_profile for people, projects, and recurring subjects. Evidence first, questions second.
