...
export function formatWorkChatContext(detail: WorkChatContextData): string {
  ...
  sections.push(
    ...
    `- If the user corrects progress or answers an open question, treat their statement as authoritative, search relevant connected sources for corroborating evidence, then call albatross_record_progress before albatross_replan_work.`,
