...
var form=e.target&&e.target.closest&&e.target.closest('[data-area-capture]');if(!form)return;
e.preventDefault();submitCapture(form,form.querySelector('[data-action="capture_intent"]'));
});
})();
</script>`;
