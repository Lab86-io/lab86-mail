 ...
 * project waiting to be finished; a monitor is never "done" at all.
 */
export const WORK_SHAPES = ['quick', 'project', 'practice', 'decision', 'monitor', 'recurring'] as const;
...
- practice: a repeated behavior the user wants to keep up. It has no finish line.
