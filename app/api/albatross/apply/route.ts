...
interface ApplyRouteDependencies {
...
const defaultDependencies: ApplyRouteDependencies = {
  requireCurrentUser,
...
export function createAlbatrossApplyPost(deps: ApplyRouteDependencies = defaultDependencies) {
  return async function POST(req: NextRequest) {
    ...
    try {
      ...
      // A retry after a failed apply creates only the actions that earlier
...
export const POST = createAlbatrossApplyPost();
