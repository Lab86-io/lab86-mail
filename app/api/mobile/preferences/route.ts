  ...
  async function put(request: Request) {
    try {
      ...
      await deps.convexMutation((api as any).albatrossNotifications.saveMobilePreferences, {
        ...
        urgentMailPushEnabled: body.urgentMailPushEnabled,
        eventSuggestionPushEnabled: body.eventSuggestionPushEnabled,
        oneTimeCodeAutofillEnabled: body.oneTimeCodeAutofillEnabled,
        oneTimeCodeCleanupEnabled: body.oneTimeCodeCleanupEnabled,
