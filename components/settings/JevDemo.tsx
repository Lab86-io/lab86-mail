  ...
  return (
    ...
    >
      ...
      <p className="text-xs leading-relaxed text-[var(--color-text-muted)]">
        Try an example or edit the text. The selected classifier will classify it now using the same questions
        as incoming mail. This demo does not change your mailbox.
      </p>
      <form
        className="space-y-3"
          ...
          >
            <div className="flex flex-wrap items-baseline justify-between gap-2">
              ...
              <span className="text-xs tabular-nums text-[var(--color-text-muted)]">
                {result.model}: {result.inferenceMs} ms
              </span>
            </div>
