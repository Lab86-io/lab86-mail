...
import { EventBlock } from '@/components/calendar/engine/event-block';
import { getEventBlockStyle } from '@/components/calendar/engine/helpers';
...
export function RenderGroupedEvents({ groupedEvents, day }: RenderGroupedEventsProps) {
  return groupedEvents.flatMap((group, groupIndex) =>
    group.map((event) => {
