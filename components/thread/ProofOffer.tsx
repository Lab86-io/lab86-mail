...
export function ProofOffer({
  ...
  if (attached) {
    return (
      <div className="mt-4 rounded-card border border-[var(--color-success)] bg-[var(--color-success-soft)] px-3.5 py-2.5">
  ...
  return (
    <div className={cn('surface-card surface-accent mt-4 rounded-card px-3.5 py-2.5')}>
